// Generated on 2018-01-22 using generator-mendix 2.2.3 :: git+https://github.com/mendix/generator-mendix.git
/*jshint -W069*/
/*global module*/
"use strict";
...
var WIDGET_XML = path.join(currentFolder, "/src/", pkg.widgetName, "/", pkg.widgetName + ".xml");
...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        copy: {
            ...
            mpks: {
                files: [
                    { dest: TEST_WIDGETS_FOLDER, cwd: "./dist/", src: [ pkg.widgetName + ".mpk"], expand: true }
                ]
            }
        },
        clean: {
            build: [
                path.join(currentFolder, "dist", pkg.widgetName, "/*")
            ]
        },
        csslint: {
            strict: {
